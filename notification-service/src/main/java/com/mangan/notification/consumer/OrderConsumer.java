...
public class OrderConsumer {
	...
	@KafkaListener(topics = "order-topic", groupId = "order_group", containerFactory = "containerFactory", concurrency = "3")
	public void handleNotification(@Payload OrderPlacedEvent orderPlacedEvent, Acknowledgment acknowledgment) {
		try {
			...
			String message = String.format("Order with ID: %s has been placed successfully!",
